...
import com.devid.service.GoodsTypeService;
...
public class GoodsTypeAdminController {
	...
	public Map<String,Object> save(String name,Integer parentId)throws Exception{
		...
		goodsType.setState(0); //当前新增节点无子节点，state为0
		goodsTypeService.save(goodsType);
		//新增节点为上一级的子节点，设置上一级节点state为1
		...
		logService.save(new Log(Log.INSERT_ACTION,"添加商品类别信息"));
